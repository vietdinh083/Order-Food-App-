...
class RvFoodAdapter(private val foodModelList: List<FoodModel>, val OnItemClickListenner: RvItemClick) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.custom_item_recycle_view, parent, false)
